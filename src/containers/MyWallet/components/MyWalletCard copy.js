...
import { isLoggedIn, listwalletAPI, createPaymentAPI, paymentConfigAPI, walletProcessAPI } from '../../App/ApiIntegration'
import {
  Link
    ...
    createPaymentAPI({ amount: this.state.amount, keyid: keyId, keySecret: keySecret, currency: currency }, (response) => {
      ...
      if (response.response.data.success == true) {
        let options = {
          ...
          "amount": response.response.data.data.amount, 
          "name": "Rising 11",
    ...
    return (
      <div className="bg">
        ...
        <header>
          ...
          <div className="team white">
            <div id="myNav" >
              <div className="overlay-content mg-20">
                ...
                <br /><br />
                <button  onClick={()=>this.openNav()} className="text-red add-cash p-14 ">Add Cash</button>
          ...
          <div class="modal fade" id="myNav1">
            <div class="modal-dialog">

              <div class="modal-content p-14">
                <div class="modal-header">
                  <button type="button" class="close" onClick={this.closeNav}>&times;</button>
